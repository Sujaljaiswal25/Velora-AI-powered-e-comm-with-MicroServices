...
// Prefer GOOGLE_API_KEY (LangChain default), but also accept GEMINI_API_KEY for convenience.
const apiKey = process.env.GOOGLE_API_KEY || process.env.GEMINI_API_KEY;
if (!apiKey) {
  throw new Error(
    "Missing API key for Google Generative AI. Please set GOOGLE_API_KEY or GEMINI_API_KEY in your .env file."
  );
}
